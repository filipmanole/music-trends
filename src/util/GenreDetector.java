 ...
 * @author calinburloiu
 */
public class GenreDetector implements Serializable{
	 ...
	 */
	public Tuple2<Genre, Genre> detectGenre(String[] terms, float[] importances)
	{
		float maxImportance = 0.0f;
		Genre maxGenre1 = Genre.OTHER;
		Genre maxGenre2 = Genre.OTHER;
		...
		return new Tuple2<> (maxGenre1, maxGenre2);
	}
